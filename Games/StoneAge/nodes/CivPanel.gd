...
func set_card_data(card,data):
	card.get_node("rec/r1").texture = load("res://Games/StoneAge/assets/res/"+data[0]+".png")
	card.get_node("bon/r1").texture = load("res://Games/StoneAge/assets/res/"+data[1]+".png")
	card.get_node("cost2/r1").texture = load("res://Games/StoneAge/assets/res/"+data[1]+".png")
